      ...
      const row = new Discord.MessageActionRow()
        .addComponents(
          new Discord.MessageButton()
            ...
            .setEmoji('<a:carregando_2:1121658406734934121>')
            .setLabel('Continuar')
            .setStyle('SUCCESS'),
        )
        .addComponents(
        ...
        const embed = await message.reply({ embeds: [new Discord.MessageEmbed()
          ...
          .addField(`<:Caixa:1121658402448343070> Estoque:`, `Nenhum...`)
             ...
             collector.on("collect", message => {
               ...
               for (let i = 0; i != estoque.length; i++) {
                 ...
                 if(i + 1 === estoque.length) {
                   ...
                   msg.edit(`<a:carregando_2:1121658406734934121> | Gift \`${gerado}\`\ Criado com sucesso!`)
                   const embednew = new Discord.MessageEmbed()
                     .setTitle(`${config.get(`title`)} | Criação de Gift Card`)
                     .addField(`<:Caixa:1121658402448343070> Estoque:`, `${texto}`)
                     .addField(`🔤 Código:`, `${gerado}`)
